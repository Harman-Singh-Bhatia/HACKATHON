...
// City Profiles with Mix data
const cityData = {
    tokyo: { required: 15400000, startAvailable: 6160000, growthRate: 0.1, mix: { solar: 55, wind: 25, bio: 20 }, status: 'Transitioning' }, // ~40%
    new_york: { required: 12200000, startAvailable: 3660000, growthRate: 0.08, mix: { solar: 40, wind: 50, bio: 10 }, status: 'High Emissions' }, // ~30%
    london: { required: 8800000, startAvailable: 4400000, growthRate: 0.15, mix: { solar: 30, wind: 60, bio: 10 }, status: 'Transitioning' }, // ~50%
    reykjavik: { required: 450000, startAvailable: 445000, growthRate: 0.01, mix: { solar: 0, wind: 10, bio: 90 }, status: 'Climate Positive' } // ~98.8%
};
